...
description: >-
  ...
  투자계약서와 투자심사보고서로부터 「준법사항체크리스트(준법감시보고서)」 한글(.hwpx) 문서와
  「투자계약서 체크리스트 및 의무기재사항확인서」 Word(.docx) 문서를 자동 생성한다. 다음 상황에서 사용:
  투자계약서·투자심사보고서(docx/hwp/pdf)를 제시하며 "준법감시보고서 작성", "준법사항체크리스트 작성",
  "체크리스트 만들어줘"를 요청할 때, 또는 투자건의 준법사항·의무기재사항 검토가 필요할 때.
---

# 준법감시보고서 작성

투자계약서와 투자심사보고서를 입력받아, **투자계약 전 준법감시인이 작성해야 하는 2종의 산출물**을
자동 생성하는 스킬이다.

1. **준법사항체크리스트(준법감시보고서)** — 한글 `.hwpx` (정본)
2. **투자계약서 체크리스트 및 의무기재사항확인서** — Word `.docx`
...
| `--compliance-format` | 준법감시보고서 형식 `hwpx`(기본)/`docx`/`both`. docx 는 한컴오피스 COM 필요 |
