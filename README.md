...
투심보고서·계약서에 **사업자등록번호·설립일·주소**가 없는 경우(축약본/마스킹), Claude에게
확정된 사업자등록번호를 알려주면 bizno.net 에서 설립일·주소·법인번호를 자동 보완합니다.
**미상 필드는 빈칸으로 남아** 준법감시인이 직접 채웁니다. (준법문서 임의주입 금지 — 확정값만 주입)
